...
describe('controller', function () {
	...
	describe('routing', function () {
		...
		it('should show active entries', function () {
			// TODO: write test
			var todoActive = {title: 'my todo', completed:false};
			//var todoCompleted = {title: 'completed todo', completed: true}
			//setUpModel([todoActive, todoCompleted]);
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			// TODO: write test
			var todo1 = {id: 43, title: 'my todo', completed: false};
			var todo2 = {id: 44, title: 'my todo', completed: false};
			setUpModel([todo1, todo2]);
			
			subject.setView('');
			
			view.trigger('toggleAll', {completed: true}); // just like this for line 215
		...
		it('should update the view', function () {
			...
			subject.setView('');
			subject.toggleAll(true); // use trigger
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
			// TODO: write test
			var todo={id: 45, title: 'my todo', completed: true};
			setUpModel([todo]);
			subject.setView('');
			subject.removeItem(45); // should use trigger with a subject with id inside
			expect(model.remove).toHaveBeenCalledWith(45, jasmine.any(Function));
		});
